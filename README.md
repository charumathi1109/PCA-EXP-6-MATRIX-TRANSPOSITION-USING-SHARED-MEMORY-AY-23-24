...
<img width="1733" height="368" alt="image" src="https://github.com/user-attachments/assets/e5d54cf6-ca17-444d-bc6d-1278f8573260" />


## RESULT:
Thus the program has been executed by using CUDA to transpose a matrix. It is observed that there are variations shared memory and global memory implementation. The elapsed times are recorded as different for each shared memory access pattern.
